...
[부칙]
1. 이 약관은 2026년 5월 26일부터 적용됩니다.
2. 2025년 12월 24일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다.`,
    bay: `## 제 1 장 총칙

**제 1 조 (목적)**

이 약관은 주식회사 아이템베이(이하 “회사”라고 합니다.)가 인터넷사이트(http://www.itembay.com)를 통하여 제공하는 중개서비스 및 기타 정보서비스(이하 “서비스”라고 합니다.)와 관련하여 회사와 회원간의 권리와 의무, 책임사항 및 회원의 서비스이용절차에 관한 사항을 규정함을 목적으로 합니다.
...
1. 중개서비스
						      ...
						      회사가 인터넷사이트(http://www.itembay.com)를 통하여 회원 상호간에 상품매매거래가 이루어질 수 있는 사이버 거래장소를 온라인으로 제공 하는 서비스 및 관련 부가서비스 일체를 말합니다.

2. 기타 정보서비스

						      중개서비스 이외에 회사가 인터넷사이트(http://www.itembay.com)를 통하여 회원에게 온라인으로 제공하는 정보서비스 등의 인터넷서비스를 말합니다.

**제 5 조 (용어의 정의)**

아래의 페이지에서 본 약관에서 사용하는 용어의 정의를 확인 할 수 있습니다.
						용어 정의 자세히 보기
...
① 회사가 제공하는 서비스에 관한 이용계약(이하 “이용계약”이라고 합니다.)은 서비스를 이용하고자 하는 자가 회사가 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 하면, 회사는 이를 이용신청으로 보고, 승낙함으로써 성립합니다.

② 아이디(ID)는 실명 1인당 1개의 아이디만을 사용할 수 있으며, 이용계약은 아이디(ID) 단위로 체결하는 것을 원칙으로 합니다.

③ 서비스를 이용하고자 하는 자는 제1항의 이용신청 시 반드시 본인의 실제 정보를 기재하여야 합니다. 그러지 아니한 경우 회원은 법적인 보호를 받을 수 없으며, 이에 따른 민사, 형사상의 모든 책임은 가입한 회원에게 있습니다. 또한 이용약관 제17조에 따라 서비스 이용에 제한이 있을 수 있습니다.

④ 통합 로그인 서비스의 이용 제공은 회원 가입 시 회사가 제공하는 패밀리 사이트 서비스 이용 및 통합 로그인에 동의하고, 회사가 이를 승낙 함으로써 성립하고 제공됩니다.
...
② 회사는 개인회원가입신청의 경우 법령에 따라 신용정보업자 또는 신용정보집중기관의 아이핀, 휴대폰 인증 방법을 통하여 개인정보와 성명의 일치 여부를 확인함으로써, 실명확인절차를 취합니다. 회사는 실명확인절차를 취할 수 없는 이용신청에 대해서는 신청자에게 증빙자료를 요청할 수 있습니다.
...
④ 회사는 다음과 같은 사유가 있는 경우, 이용신청에 대한 승낙을 거부할 수 있습니다.
					        ...
					        2. 이미 가입된 회원과 이름 및 개인정보가 동일한 경우

					        3. 이 약관 제9조에 기하여 회사가 이용계약을 해지한 전(前)회원이 재이용신청을 하는 경우

					        4. 이 약관 제17조에 기하여 회사로부터 회원자격정지조치를 받은 회원이 이용정지 중에 이용계약을 임의 해지하고 재이용신청을 하는 경우

					        5. 만 14세 미만의 자가 이용신청을 하는 경우

					        6. 가입 신청 시 기재하여야 할 필수기재항목에 허위사실을 기재한 경우

					        7. 기타 위법 또는 부당한 이용신청임이 확인된 경우
...
② 회원의 해지
							...
							1. 회원은 언제든지 회사에게 해지의사를 통지함으로써 이용계약을 해지할 수 있습니다. 다만, 회원은 해지의사를 통지하기 전에 모든 구매 또는

						    판매중인 매매절차를 완료, 철회 또는 취소해야만 해지의 의사표시를 할 수 있습니다. 이 경우 매매의 철회 또는 취소로 인한 불이익은
...
단, 이 약관 제10조 7항에 따라 회사가 회원의 정보를 보존하고 있는 기간 내 재가입할 경우 회원은 기존에 사용하였던 아이디(ID)로만 재이용이 가능합니다.

③ 회사의 해지

          					1. 회사는 다음과 같은 사유가 있는 경우, 이용계약을 해지할 수 있습니다. 이 경우 회사는 회원에게 E-mail, 전화, 팩스, 기타의 방법을 통하여

          					해지사유를 밝혀 해지의사를 통지합니다. 다만, 회사는 해당 회원에게 사전에 해지사유에 대한 의견진술의 기회를 부여할 수 있습니다.

          					가) 회원에게 제8조 4항에서 정하고 있는 이용계약의 승낙거부사유가 있음이 확인된 경우

          					나) 회원이 매매부적합상품을 판매등록 하거나, 기타 공공질서 및 미풍양속에 위배되는 상품거래행위를 하거나 시도한 경우

          					다) 회원이 회사나 다른 회원, 기타 타인의 권리나 명예, 신용, 기타 정당한 이익을 침해하는 행위를 한 경우

          					라) 회원이 직거래 등 회사가 제공하는 서비스의 원활한 진행을 방해하는 행위를 하거나 시도한 경우

          					마) 회원이 실제로 상품을 판매하고자 하는 의사 없이 상품등록을 한 경우 또는 이를 알고 낙찰 받은 것으로 인정되는 경우

          					바) 상품사기 등 범죄를 유발 한다고 회사가 판단하는 행위

          					사) 타인의 결제수단(신용카드 / 휴대폰 번호)을 도용한 경우

          					아) 타인의 ID를 도용한 경우

          					자) 본 약관의 내용을 위반하는 행위

          					차) 게임산업진흥에관한법률 시행령 제18조의3 제3호의 각 목에 해당하는 상품을 판매하여 게임산업진흥에관한법률 제32조 제7항을 위반한 경우

2. 이용계약은 회사의 해지의사가 회원에게 도달한 때에 종료되나, 회원이 제공한 연락처 정보의 오류로 인하여 회사가 해지의사를 통지할 수

          					없는 경우에는 회사가 마이페이지에 해지의사를 공지하는 때에 종료됩니다.

3. 회사가 이용계약을 해지하는 경우, 회사는 별도의 통지 없이 해당 회원과 관련된 매매를 취소할 수 있습니다.

4. 이용계약이 종료되는 경우, 회사는 해당 회원의 마일리지를 정산합니다. 정산 후, 마일리지가 잔존하는 경우 회사는 해당 회원의 요청이

          					있은 후 7일 이내에 해당회원의 입금계좌로 그 금액을 송금합니다.

5. 이용계약의 종료와 관련하여 발생한 손해는 이용계약이 종료된 해당 회원이 책임을 부담하여야 하고, 회사는 일체의 책임을 지지 않습니다.

## 제 3 장 회원정보의 보호

**제 10 조 (회사의 의무)**

① 회사는 이용계약을 위하여 회원이 제공한 정보 외에도 수집목적 또는 이용목적을 밝혀 회원으로부터 필요한 정보를 수집할 수 있습니다.

          					이 경우, 회사는 회원으로부터 정보수집에 대한 동의를 받습니다.

② 회사가 정보수집을 위하여 회원의 동의를 받는 경우, 회사는 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공관련사항(제공 받는 자,

          					제공목적, 제공정보의 내용)을 미리 명시하거나 고지합니다. 회원은 정보제공에 동의하더라도 언제든지 그 동의를 철회할 수 있습니다.

③ 회사는 회원의 원활한 상담 및 본인확인등을 위하여 회원으로부터 개인정보를 제공 받을 수 있으며, 회원이 이를 거부할 경우 회사의 상담에

          					일부 제약이 있을 수 있습니다.

④ 회사는 회원 자신의 정보 열람 및 잘못된 정보에 대한 정정에 성실히 응하여야 합니다. 또한  회사는 회원으로부터 정보정정의 요청이 있는

          					경우 그 오류가 시정될 때까지 당해 정보를 이용하지 않습니다.

⑤ 회사는 아이디(ID) 등 서비스화면을 통하여 공개되는 정보를 제외하고는 회사가 수집한 회원정보를 정보수집 시에 밝힌 수집목적, 이용목적,

          					원활한 서비스의 제공 및 제공서비스의 확대 외의 용도로 사용하거나 당해 회원의 동의 없이 제3자에게 제공하지 않습니다.

          					다만, 다음의 경우는 예외로 하며, 이 경우 회사는 동 정보를 열람할 수 있는 방법을 회원에게 제공합니다.

          					1. 법령이 회원정보의 이용과 제3자에 대한 정보제공을 허용하고 있는 경우

          					2. 통신비밀보호법, 부가가치세법 등 국가기관의 법령에 의한 자료제공요청이 있는 경우

⑥ 회사는 회원정보의 보호를 위하여 관리자를 최소한으로 한정하며, 회사의 고의 또는 과실로 인하여 회원정보가 분실, 도난, 유출, 위조, 변조 또는 훼손된

          					경우에는 그로 인한 회원의 손해에 대하여 모든 책임을 부담합니다.

⑦ 이용계약이 종료된 경우, 회사는 당해 회원의 정보를 파기하는 것을 원칙으로 합니다. 다만, 관계  법령 및 운영방침에 의한 경우에는 그에

          					따라 보관 및 파기합니다. 자세한 내용은 개인정보처리방침에 따릅니다.

⑧ 회사는 회원정보의 보호와 관리에 관한 개인정보처리방침을 회원과 회사의 서비스를 이용하고자 하는 자가 알 수 있도록 인터넷사이트

          					(http://www.itembay.com)에 공개합니다.

**제 11 조 (회원의 의무)**

① 회원은 회사에게 정보를 제공하고자 하는 경우 사실대로 제공하여야 합니다.

② 회원은 이용신청 시 기재한 사항이 변경되었을 경우, 즉시 해당 사항을 수정해야 합니다. 단, 아이디(ID) 및 성명은 수정할 수 없음을

          					원칙으로 합니다. 만약 회원 정보가 변경되었음에도 이를  반영하지 않거나, 오기입으로써 발생하는 모든 피해는 회원이 부담해야 합니다.

③ 아이디(ID) 및 비밀번호("게임비밀번호" 및 본인인증서비스를 통한 각종 인증번호 포함, 이하 "비밀번호"라고 합니다.)에 대한 관리책임은

          					회원에게 있으며, 회원은 아이디(ID) 및 비밀번호를 타인에게 양도, 대여할 수 없습니다.

④ 회원이 아이디(ID) 또는 비밀번호를 도난 당하거나 제3자가 이를 사용하고 있음을 인지한 경우, 즉시 회사에게 통보하여야 하고, 회사의
...
② 현금영수증의 발급
          					...
          					1. 회사는 관련 법령에 의해 사이트를 통해 거래 완료된 상품의 현금구매액에 대해 판매회원을 대신하여 구매자에게 현금영수증을 발급합니다.

          					2. 전 항의 경우 회사는 과세당국의 요청에 의하여 구매자가 요청하지 않은 경우에도 현금영수증을 발급할 수 있으며, 이에 대한 내역은 국세청

          					현금영수증 홈페이지(http://www.hometax.go.kr)에서 확인할 수 있습니다.

③ 회사의 면책

          					회사는 법령에 의해 회원에게 부과되는 세액 및 본 약관의 동의 하에 관계기관에 제공되는 매출자료 등에 대해서는 어떠한 책임도 지지 않습니다.
...
② 회사는 중개서비스의 종류에 따라 각 매매의 특성, 매매절차 및 매매방법에 대한 사항을 서비스화면을 통하여 공지합니다.

          					회원은 회사가 공지한 각 매매에 관한 사항을 사전에 충분히 이해하고 중개서비스를 이용하여야 합니다.

③ 회원은 아이디(ID)와 비밀번호를 통하여 회사가 제공하는 중개서비스에 접속할 수 있고, 동 중개서비스를 이용하여 상품을 판매하거나 구매할 수 있습니다.

④ 회원이 중개서비스를 통하여 판매 또는 구매하는 경우, 반드시 회사가 마련한 매매보호 서비스를 통하여 거래를 완료하여야 합니다.

          					회사는 회원간의 직거래로 인하여 발생한 문제에 대하여 책임지지 않습니다.

**제 14 조 (서비스 내용의 공지 및 변경)**

① 위 제13조 각 항의 서비스 이용에 관해 필요한 사항은 회사가 정하여 서비스 화면의 공지사항 및 이용안내 게시판 또는 별도의 내용으로 공지합니다.

② 회사는 서비스 내용이 변경되는 경우, 변경일 7일 이전에 공지하는 것으로 합니다. 다만, 급박한 사정이 있는 경우에는 그 사정을 공시하고

          					서비스 내용을 변경할 수 있습니다. 회원이 공지 내용을 조회하지 않아 입은 손해에 대하여는 배상하지 않습니다.

**제 15 조 (부가서비스)**

① 회사가 제공하는 중개서비스 이외의 추가제공서비스로 자체적인 서비스 개발 및 타사와의 업무제휴를 통해 회원들에게 신규 도입, 제공되는

          					서비스를 말합니다.

② 회사는 회원들에게 유료등록 서비스를 제공합니다.

          					1. 유료등록 서비스는 회원의 상품을 홍보할 수 있도록 회사가 일정금액을 신청 회원에게 지급 받고 제공하는 서비스로서, 상품리스트 페이지

          					최상단에 노출 또는 상품제목의 특수 노출 등 차별화된 방식으로 광고할 수 있는 유료서비스 입니다.

          					본 서비스는 회원등급에 구분 없이 모든 회원이 신청하여 이용가능하며, 본 서비스 구입 후 환불은 불가능 합니다.

**제 16 조 (서비스의 유지 및 중지)**

① 회사는 서비스 제공 설비를 항상 운용 가능한 상태로 유지하기 위하여 노력하며 서비스 제공설비에 장애가 발생하거나 또는 그 설비가

          					멸실될 때 에는 이를 신속하게 수리, 복구해야 합니다.
...
② 회사는 다음 각 호에 해당하는 경우 서비스 제공을 중지할 수 있습니다.
          					...
          					3. 국가 비상 사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우

③ 위 제2항 각호의 경우에 의한 서비스 제공 중단 시 회사는 회원들이 입은 손해에 대해 책임을 지지 않습니다.

**제 17 조 (중개서비스 이용정지)**

회사는 중개서비스를 통한 거래의 안전성과 신뢰성을 위하여 일정한 정지사유 발생 시 회원자격을 정지할 수 있습니다.

          					서비스 이용 제한에 대해서는 회사가 정하는 서비스 운영정책에 따릅니다.

**제 18 조 (회원의 등급 관리)**

① 회사는 서비스의 신뢰성 향상을 위하여 등급 서비스를 제공합니다. 단, 회원의 등급은 거래의 참고자료에 불과하며 회원의 신용을 보증하거나

          					금융상의 신용상태를 의미하는 것은 아닙니다.

② 회원 등급은 거래 횟수를 기준으로 기간별로 구분하여 부여합니다.

          					1. 상품의 판매 완료 또는 구매 완료 시 거래 횟수가 1회 추가 됩니다.

          					2. 회사의 분류기준에 따라 5단계의 회원등급으로 구분 합니다.

          					3. 회원등급은 산정 기준에 따라 실시간 반영됩니다.

③ 회사는 다음과 같은 회원등급에 따라 회원에게 거래 혜택을 제공하고 있습니다.

| 등급 | Level1 | Level2 | Level3 | Level4 | Level5 |
|---|---|---|---|---|---|
| 거래 혜택 | 없음 | 없음 | 없음 | 없음 | 은행 출금 수수료 / 월 15회 무료 |

④ 회사는 서비스 신뢰성 향상을 위해 회원등급 추출 방법, 등급 부여 일정, 등급별 혜택 사항을 변경 할 수 있습니다.

**제 19 조 (대리 및 보증의 부인)**

① 회사는 회원 상호간의 거래를 위한 온라인 거래장소(marketplace)를 제공할 뿐이므로 상품을 판매하거나 구매하고자 하는 회원을 대리하지

          					않습니다. 또한, 회사의 어떠한 행위도 판매자 또는 구매자를 대리하는 행위로 간주되지 않습니다.

② 회사는 중개서비스를 통하여 이루어지는 회원간의 판매 및 구매와 관련하여 판매의사 또는 구매의사의 존부 및 진정성, 등록상품의 품질,

          					완전성, 안전성, 적법성 및 타인의 권리에 대한 비침해성, 회원이 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 등

          					일체에 대하여 보증하지 아니하며, 이와 관련한 일체의 위험과 책임은 해당 회원이 부담해야 합니다.

③ 회사는 회원이 게재하는 상품설명 등의 제반 정보를 통제하거나 제한하지 않습니다. 다만, 회사는 회원이 게재한 정보의 내용이 타인의 명예,

          					권리를 침해하거나 거래와 상관없는 내용 게재 및 법 규정을 위반한다고 판단하는 경우에는 이를 삭제할 수 있고, 거래취소, 거래중지, 기타

          					필요한 조치를 취할 수 있습니다.

④ 회사는 회사에 연결(하이퍼링크)된 사이트가 취급하는 상품 또는 용역에 대하여 보증책임을 지지 아니 합니다.

          					회사와 회사에 연결된 사이트는 독자적으로 운영되며 회사는 회사 연결사이트와 회원간에 행해진 거래에 대하여 어떠한 책임도 지지 아니합니다.

**제 20 조 (매매보호 서비스)**

① 회사는 중개서비스를 제공하는 과정에서 대금의 수령, 보관 및 송금업무로 이루어지는 매매보호 서비스를 제공합니다. 이러한 매매보호

          					서비스는 중개서비스를 통하여 이루어지는 회원 상호간의 거래의 안전성과 신뢰성을 도모하고, 구매자를 보호하기 위한 목적에서 제공하는

          					장치이므로, 회사가 매매보호 서비스를 통하여 판매자 또는 구매자를 대리, 대행하거나 그 이행을 보조하는 것은 아닙니다.

② 회사가 제공하는 매매보호 서비스는 기본적인 중개서비스에 포함됩니다. 매매보호 서비스를 통하지 않는 직거래를 유도하는 경우, 회사는

          					거래취소, 거래중지 등 기타 필요한 조치를 취할 수 있습니다.

③ 매매보호 서비스의 일환으로 이루어지는 대금보관으로 인하여 회사가 취득하는 이자 등은 서비스 제공의 대가이므로, 회원은 회사에 대하여

          					이자 등의 반환을 청구할 수 없고, 대금송금으로 인하여 발생하는 수수료는 대금을 송금하는 회원이 부담하여야 합니다.

④ 회사가 제공하는 매매보호 서비스를 이용하지 않은 거래 및 상품 또는 매매보호 서비스를 이용한 거래 및 상품에 대하여 매매보호 서비스가

          					종결된 경우 해당 거래와 관련하여 발생한 모든 사항은 판매자와 구매자가 상호협의를 통해 해결하여야 합니다.

⑤ 회원은  회사가 제공하는 서비스를 이용함에 있어서 매매보호 서비스의 이용과 그 규칙에 동의하여야 합니다.

⑥ 회사가 제공하는 매매보호 서비스를 오용, 악용함으로써 사회질서, 미풍양속을 침해하거나 침해할 우려가 있다고 판단되는 경우 또는 회사가

          					매매보호 서비스를 제공하지 못할 상황 또는 사유가 발생하는 경우 회사는 매매보호 서비스를 상품의 일부 또는 전부에 대하여 제공하지 않거나

          					제한할 수 있습니다.

⑦ 매매보호 서비스를 이용함에 있어 회원은 다음에 기재한 사유가 발생하지 않도록 유의하여야 합니다.

          					1. 카드의 미서명, 관리소홀, 대여, 양도, 보관, 이용위임, 담보제공, 불법대출 등으로 인한 부정사용 또는 위, 변조사고

          					2. 회원의 가족, 동거인(사실상의 동거인 포함)에 의하거나 또는 이들이 관련하여 생긴 부정사용 또는 위, 변조사고

          					3. 카드 비밀번호 유출로 인한 부정사용 또는 위, 변조사고

          					4. 본인인증 서비스의 인증번호 관리소홀로 인한 위, 변조사고

**제 21 조 (중개서비스 이용자의 의무)**

① 상품을 판매(구매) 하고자 하는 회원은 회사가 제공하는 상품등록 양식에 따라 상품을 등록하여야 합니다.

② 판매(구매)를 목적으로 제출한 상품에 대한 설명에는 거짓이 없어야 하며, 회사가 정하는 양식에 어긋난 등록이나 허위 등록으로 인한 손해

          					또는 손실에 대한 책임은 상품 등록자가 부담해야 합니다.

③ 형법 및 각종 법률 또는 규정에 의해 거래가 불가능한 상품을 거래 할 수 없습니다.

④ 기타 운영자가 판단하여 회사의 서비스와 적합하지 않은 상품이라 판단되면 판매를 제한할 수 있습니다.

⑤ 회사는 관련 법령 또는 규정에 의해 판매자의 게임머니 및 게임아이템의 판매를 제한할 수 있으며,

          					회원은 회사의 이와 같은 조치에 이의를 제기할 수 없습니다.

⑥ 중개서비스 이용 중 거래대금 결제 후 거래완료 또는 취소 전에 거래당사자 간 분쟁이 발생할 경우, 회사가 회원의 매매보호를 위해 거래당사자 간

          					협의가 완료될 때까지 마일리지를 보류할 수 있습니다.

⑦ 중개서비스 이용 중 발생되는 사고 중 안전 거래 방법을 숙지하지 못하여 발생한 사고에 대한 책임은 고객에게 있으며, 자세한 안전거래 방법에

          					대해서는 회사가 정하는 서비스 운영정책에 따릅니다.

⑧ 거래 시 발생되는 모든 수수료 및 이용요금은 회원의 부담으로 합니다.

⑨ 중개서비스를 이용하여 거래하는 경우 회원은 당사자와 거래로 인한 위험이 없다고 스스로 판단하였을 경우 거래가 이루어지는 것입니다.

          					그러므로 중개서비스를  이용하여 회원이 스스로 결정한 거래에 의해 발생하는 사기 등의 피해에 대하여 회사는 책임이 없습니다.
...
② 판매자는 상품 전달 시 회사의 구매자 정보를 확인 하여 정확하게 전달 해야 하며, 게임 용품 판매의 경우 송장 번호 등 배송 정보를 구매자에게

          					제공하여야 합니다. 또한 상품 전달을 하지 않거나 잘못 전달한 상품에 대한 책임 및 상품 전달 지연에 따른 모든 책임은 판매자에게 있습니다.

③ 특별한 사유 없이 상품 전달을 지연 시킬 경우 운영자 판단으로 거래를 취소 할 수 있습니다.

④ 판매자는 정당한 상담, 반품 및 환불 요구를 들어줄 의무가 있습니다. 자세한 반품 및 환불 규정은 회사가 정하는 서비스 운영정책에 따릅니다.

⑤ 판매자가 상품을 전달한 후 해당 게임 서비스 업체의 서비스 이상으로 서버를 이전 상태로 되돌림으로써 상품 전달 전의 상황으로 되었을 경우 구매자에게

          					환불 또는 거래 상품을 재 전달 해야 합니다.

⑥ 판매자는 해당 게임서비스에 이상이 발생되어 상품이 전달되지 않았을 경우는 재차 상품을 전달하여야 합니다. 만약, 판매자가 상품을 전달하지 못할

          					경우에는 회사로부터 출금 받은 거래액을 회사에 재 입금을 해야 합니다. 이에 대한 모든 민사적, 형사적 책임은 판매자에게 있습니다.

⑦ 거래 시 판매자의 허위 정보로 인하여 발생 되는 모든 사항의 책임은 판매자에게 있습니다.

⑧ 판매자는 판매 거부 시 회사에 판매거부 신고를 해야 합니다. 단, 판매 거부 시에는 제17조에 의거하여 제재 받을 수 있습니다.

⑨ 구매자가 정당한 사유 없이 구매 거부 시 판매자는 회사에 구매 거부 신고를 해야 합니다.

⑩ 구매자의 정당한 구매취소 및 반품에 대하여 판매자는 이를 들어줄 의무가 있습니다.

**제 23 조 (구매자의 의무)**

① 구매자는 판매자가 안전하게 상품을 전달 할 수 있도록 정확한 구매자 정보를 작성해야 합니다. 또한 거래 시 구매자의 잘못된 정보 기재 및 허위 정보 기재에

          					따라 발생 되는 모든 책임은 구매자에게 있습니다.

② 구매상품에 대한 반품 및 환불 요구는 판매자에게 요청 해야 하며, 자세한 반품 및 환불 규정은 회사가 정하는 서비스 운영정책에 따릅니다.

③ 구매자는 구매신청한 상품 대금을 회사에서 제공하는 결제방법을 이용하여 마감 후 구매신청 시점부터 30분 이내 또는 상품 대금만큼

							마일리지를 보유하고 있을 경우 즉시 결제할 의무가 있으며, 상품을 수령한 이후 구매자의 인수 확인 지연으로 인하여 발생하는 책임은

          					구매자가 부담합니다.

④ 거래자간의 분쟁이 발생 된 경우 회사에 분쟁 접수된 날로부터 30일이 경과하도록 분쟁 해결을 위한 행위가 진행 되지 않을 시, 회사는

							구매자에게 인수확인 의사가 있는 것으로 간주하여 판매자에게 상품대금을 지급할 수 있습니다.

⑤ 전항에 따른 경우 상품대금 지급 7일 전 회사는 구매자에게 해당 내용 통보 및 의사표시를 요청하며, 상품대금 지급일이 경과하도록 구매자의

							의사표시가 없는 경우 인수확인 의사가 있는 것으로 간주하여 회사는 판매자에게 상품대금을 지급하며 이에 따른 책임은 거래당사자 간에

							부담합니다. 다만, 회사가 판매자에게 상품대금을 지급하기 이전에 구매자가 취소 의사를 표시한 경우에는 그 지급을 보류할 수 있습니다.

⑥ 구매자는 구매 거부 시 회사에 구매 거부 신청을 해야 하며, 이 경우 제17조에 의거하여 제재 받을 수 있습니다.

⑦ 판매자가 정당한 사유 없이 판매 거부 시 구매자는 회사에 판매 거부 신고를 해야 합니다.

⑧ 판매자가 판 상품에 하자가 있거나 상품 등록 정보와 현저히 다를 경우 구매자는 정당하게 구매를 취소할 수 있으며 회사는 이로 인해 제17조에 의거한

          					제재를 부여하지 못합니다. 단, 판매자는 제17조에 의거하여 제재 받을 수 있습니다.
...
③ 판매자와 구매자는, 신고하기를 통하여 상대방에 의해 회사에 접수된 판매거부, 구매거부 신고 내용에 대하여 의견 진술의 기회가 있으며,

          					이는 신고가 회사에 접수된 후 3일 이내에 하여야 합니다. 신고 접수 후, 의견 진술이 없을 경우 회사는 상대방의 신고 내용을 인정하는 것으로

          					간주하고 거래 종료하며, 상대방의 신고에 대하여 의견 진술을 한 경우는 운영자가 판단하여 제17조에 의거하여 제재 받을 수 있습니다.

④ 구매자 및 판매자가 자진해서 구매거부 및 판매거부를 신청한 경우에는 제17조에 의거하여 제재 받을 수 있으며, 등록된 게시물은 거래 취소가 됩니다.

⑤ 구매거부 신고 요건은 다음과 같습니다.

          					1. 구매자가 정당한 이유 없이 구매거부 의사를 밝혔을 경우

          					2. 자율 거래에서 마감 후 구매자와 연락이 되지 않거나 연락처 정보가 불량인 경우

          					3. 구매자가 입금을 약속한 후 입금 마감일이 지났을 경우

          					4. 구매자가 판매자의 거래방법에 동의하지 않는 경우

⑥ 판매거부 신고 요건은 다음과 같습니다.

          					1. 판매자가 판매거부 의사를 밝혔을 경우

          					2. 자율 거래에서 마감 후 판매자와 연락이 되지 않거나 연락처 정보가 불량인 경우

          					3. 판매자가 상품 전달을 약속한 후 상품을 전달하지 않는 경우

          					4. 판매자가 상품 등록 시 선택한 것과 다른 거래 방법을 강요할 경우

          					5. 판매자가 구매자의 거래방법에 동의하지 않는 경우

## 제 5 장 서비스 이용수수료

**제 25 조 (회원보상제도)**

회사가 제공하는 회원보상제도에 대해서는 회사가 정하는 서비스 운영정책에 따릅니다.

**제 26 조 (Mobile 아이템베이)**

① 회사는 무선인터넷 망을 통해 회원에게 Mobile 아이템베이 서비스를 제공합니다.

② [제 17 조 (중개서비스 이용정지)]에 규정에 따라 회원자격이 정지된 회원은 Mobile 아이템베이 서비스를 이용하실 수 없습니다.

③ 회사는 각종 편의 서비스를 위한 SMS, URL SMS를 발송할 수 있습니다.

**제 27 조 (수수료의 내용)**

① 회사가 부과하는 수수료는 상품의 광고효과 및 회사가 제공하는 시스템이용료로서, 부과되는 수수료는 상품 등록 수수료, 사진 등록 수수료,

          					거래 수수료로 구분됩니다.

② 상품 등록 수수료 및 사진 등록 수수료는 무료입니다.

③ 일반판매 서비스의 거래가 완료된 경우 거래 수수료를 부과합니다.

          						1. 2만원 이상의 상품 거래가 완료된 경우 거래금액의 5%를 거래수수료로 판매자에게 부과합니다.

          						2. 2만원 미만의 상품 거래가 완료된 경우 1,000원의 거래수수료를 판매자에게 부과합니다.

          						1. 상품 거래가 완료된 경우 거래금액의 5%를 거래수수료로 판매자에게 부과합니다.

          						2. 단, 최저 수수료는 50원이며, 최대 수수료는 53,000원입니다.
...
⑤ 단, 보상제도를 이용하여 상품 거래가 완료된 경우 추가 수수료를 판매자에게 부과하며, 구매자의 구매포인트는 제공되지 않습니다.
...
회원들의 매매 거래가 정상 종료되면 제28조에서 규정한 해당 거래의 수수료와 판매자의 미납수수료를 상품 대금에서 제외하고 판매자에게 마일리지로 적립합니다.

**제 29 조 (수수료 부과의 예외)**

① 구매자가 구매 거부하거나 상품을 반품한 경우에는 어떤 수수료도 부과하지 않습니다. 단, 구매자가 '상품인수확인' 버튼을 클릭하여,

          					상품대금이 판매자에게 송금된 후에 반품이 발생한 경우 해당 거래로 징수된 수수료는 환불되지 않습니다.

② 그 외에 운영자가 판단하여 운영상 상당한 이유가 있는 때에 수수료 부과의 예외사항을 정할 수 있습니다.

**제 30 조 (마일리지, 포인트, 쿠폰 제도)**

회사가 인터넷사이트를 통하여 제공하는 서비스의 이용을 위한 ‘마일리지’, ‘쿠폰’, ‘포인트’ 관련해서는 회사가 정하는 마일리지 운영정책에 따릅니다.

## 제 6 장 면책조항 등

**제 31 조 (회사의 면책)**

① 회사는 회원들에게 온라인 상의 거래장소(marketplace)를 제공하고 기타 부가정보를 제공함에 그치는 것이므로 중개서비스를 통하여

          					이루어지는 회원 상호간의 거래와 관련된 상품 하자로 인한 분쟁해결 등 필요한 사후처리는 거래당사자인 회원들이 직접 수행하여야 합니다.

          					회사는 이에 대하여 관여하지 않으며 어떠한 책임도 부담하지 않습니다.

② 회사는 천재지변 또는 이에 준하는 불가항력, 정보통신설비의 보수점검, 교체 또는 고장, 통신의 두절 등으로 인하여 일시적 또는 종국적으로

          					서비스를 제공할 수 없는 경우, 서비스 제공에 관한 책임이 면제됩니다. 이 경우 회사는 회사가 제공하는 인터넷사이트 화면에 게시하거나

          					기타의 방법으로 회원들에게 통지합니다.
...
⑥ 회사와 피연결회사(회사의 서비스 화면과 링크, 제휴 등으로 연결된 사이트를 운영하는 회사를 말합니다)는 독자적으로 운영되며, 회사는

          					피연결회사와 회원간에 이루어진 거래 또는 계약에 대하여는 책임을 지지 않습니다.
...
회사가 인터넷사이트를 통하여 제공하는 서비스 중 게시물 이용에 관련해서는 회사가 정하는 서비스 운영정책에 따릅니다.

**제 34 조 (기타조항)**

① 회사는 회원이 제기하는 정당한 의견이나 불만을 반영하고 그 문제를 해결하고 회원 상호간의 분쟁을 조정하기 위하여 고객감동센터를 설치,

          					운영합니다. 회사는 회원으로부터 제기되는 불만사항 및 의견이 정당하다고 판단되는 경우 이를 신속하게 처리하며, 즉시처리가 곤란한 경우에는

          					그 사유와 처리기간을 통보합니다.

② 본 서비스를 위반하거나 서비스 이용 시 불편 사항이 발생한 경우 주식회사 아이템베이의 “신고하기”를 이용하시거나, 고객감동센터 전화(1644-3333)

          					또는 팩스 (1644-3334)로 문의 하여 주시기 바랍니다.

③ 문의시간 : 365일 24시간 안내 (연중무휴)

④ 회사소개

          					1. 회사명 : 주식회사 아이템베이 (아이템베이)

          					2. 주 소 : 서울시 양천구 목동중앙북로 112 (목동)

          					3. 사업자 등록번호 : 105-86-44587

          					4. 대표자 : 이대훈

## 7. 부칙

이 약관은 2026년 05월 18일부터 적용되며, 이전의 약관은 본 약관으로 변경됩니다.

- 이용약관 시행일자 : 2026년 05월 18일

아이템베이는 회원 상호간의 온라인게임 상품매매거래를 중개하는 사이버 거래장소(Online Marketplace)입니다. 따라서, 상품 결함, 상품 정보 오류, 이용자간 사기행위, 반품 등 회원간 거래행위에서 발생되는 분쟁에 대해서는 아이템베이에서 책임을 부담하지 않습니다. 그러한 분쟁은 회원들 사이에서 직접 해결되는 것을 원칙으로 합니다.`
};
