    ...
    function switchChatTab(tab){
        ...
        if(tab===1){
            ...
            if(bRes&&!bRes._bwInited){
                bRes._bwInited=true;
                bRes.innerHTML='<div style="display:flex;flex-direction:column;align-items:center;padding:24px 20px;gap:16px;color:var(--text-muted,#888);">'
                    +'<div style="text-align:center;">'
                    +'<div style="font-size:36px;opacity:0.35;margin-bottom:8px;">🚫</div>'
                    +'<div style="font-size:15px;font-weight:700;color:var(--text-main,#ccc);">금칙어 조회</div>'
                    +'<div style="font-size:12px;margin-top:4px;opacity:0.6;">물품 제목을 아래 입력창에 붙여넣고 조회 버튼을 누르세요.</div>'
                    +'</div>'
                    +'<div style="width:100%;max-width:420px;background:var(--bg-card,rgba(255,255,255,0.04));border:1px solid var(--border-ui,rgba(255,255,255,0.1));border-radius:14px;padding:16px 18px;">'
                    +'<div style="font-size:12px;font-weight:800;opacity:0.5;letter-spacing:0.8px;margin-bottom:12px;">물품 제목 입력이 어려운 경우</div>'
                    +'<div style="display:flex;flex-direction:column;gap:9px;">'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
                    +'<span style="flex-shrink:0;width:20px;height:20px;border-radius:50%;background:rgba(239,68,68,0.15);color:#ef4444;font-size:11px;font-weight:900;display:flex;align-items:center;justify-content:center;">1</span>'
                    +'<span>관리자 화면 물품 제목 복사 <kbd style="font-size:11px;padding:1px 5px;border-radius:4px;border:1px solid var(--border-ui,#444);background:var(--bg-body,#0f172a);">Ctrl+C</kbd></span>'
                    +'</div>'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
                    +'<span style="flex-shrink:0;width:20px;height:20px;border-radius:50%;background:rgba(239,68,68,0.15);color:#ef4444;font-size:11px;font-weight:900;display:flex;align-items:center;justify-content:center;">2</span>'
                    +'<span>관리자 본인 아이디 검색 → 메시지 쓰기</span>'
                    +'</div>'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
                    +'<span style="flex-shrink:0;width:20px;height:20px;border-radius:50%;background:rgba(239,68,68,0.15);color:#ef4444;font-size:11px;font-weight:900;display:flex;align-items:center;justify-content:center;">3</span>'
                    +'<span>물품 제목 붙여넣기 <kbd style="font-size:11px;padding:1px 5px;border-radius:4px;border:1px solid var(--border-ui,#444);background:var(--bg-body,#0f172a);">Ctrl+V</kbd> → 보내기</span>'
                    +'</div>'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
                    +'<span style="flex-shrink:0;width:20px;height:20px;border-radius:50%;background:rgba(239,68,68,0.15);color:#ef4444;font-size:11px;font-weight:900;display:flex;align-items:center;justify-content:center;">4</span>'
                    +'<span>인터넷 PC 아이템매니아 본인 아이디 접속</span>'
                    +'</div>'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
                    +'<span style="flex-shrink:0;width:20px;height:20px;border-radius:50%;background:rgba(239,68,68,0.15);color:#ef4444;font-size:11px;font-weight:900;display:flex;align-items:center;justify-content:center;">5</span>'
                    +'<span>메시지함 → 메시지 내용 복사 <kbd style="font-size:11px;padding:1px 5px;border-radius:4px;border:1px solid var(--border-ui,#444);background:var(--bg-body,#0f172a);">Ctrl+C</kbd></span>'
                    +'</div>'
                    +'<div style="display:flex;align-items:flex-start;gap:10px;font-size:13px;line-height:1.5;">'
